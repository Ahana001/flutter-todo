    ...
    return Container(
      ...
      child: CustomPaint(
        foregroundPainter: ProgressLinePainter(
            ...
            completedPercentage:
                (widget.completedPercentage * _animation.value),
...
class ProgressLinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    progressPaint.shader =
        gradient.createShader(Rect.fromLTRB(0, 0, size.width, 0));
    canvas.drawLine(Offset(0, 0),
        Offset(size.width / 100 * completedPercentage, 0), progressPaint);
  }
